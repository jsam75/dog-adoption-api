// Import express to create the router for dog-related routes
...
// Define Routes - order matters! 1. Static routes, 2. General Collection routes, 3. Dynamic routes with :id, 
